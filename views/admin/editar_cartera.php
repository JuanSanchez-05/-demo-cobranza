<?php
$titulo = 'Editar Cartera - Administrador';
    ...
    <div class="form-container">
        <form method="POST" action="<?php echo BASE_URL; ?>controllers/AdminController.php?action=guardar_cartera">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre" value="<?php echo htmlspecialchars($cartera['nombre']); ?>" required placeholder="Ej: Cartera Centro">
            </div>

            <div class="form-group">
                <label>Descripción</label>
                <textarea name="descripcion" rows="3" placeholder="Descripción opcional de la cartera"><?php echo htmlspecialchars($cartera['descripcion'] ?? ''); ?></textarea>
            </div>
                ...
                <select name="trabajador_id" required>
                    ...
                    <?php foreach ($trabajadores as $trabajador): ?>
                        <option value="<?php echo $trabajador['id']; ?>" 
                                <?php echo ($trabajador['id'] == $cartera['trabajador_id']) ? 'selected' : ''; ?>>
